...
│   │   Outputs:  fig1–fig7 PNGs + sample_signatures/
│
├── 📁 sample_signatures/
│   ├── genuine/  ← 150 genuine signature PNG samples
│   └── forged/   ← 150 forged signature PNG samples
│
...
| Verification AUC | > 0.95 |
| Mean genuine pair score | ~0.85 |
| Mean forged pair score | ~0.55 |
| Verification threshold | 0.8 |
| Score separation gap | ~0.30 |
...
```bash
git clone https://github.com/your-username/Signature-Detection-Verification.git
